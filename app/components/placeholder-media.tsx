  ...
  return (
    ...
    >
      <div className="relative flex h-24 w-24 items-center justify-center md:h-32 md:w-32">
        ...
        <div className="relative grid h-[72%] w-[86%] place-items-center rounded-md border-8 border-[#242326] bg-[#c7c5ca]">
          <ImageIcon size={48} strokeWidth={2.5} className="text-[#242326]" />
        </div>
      </div>
    </div>
  );
