...
const links = [
  {
    label: "Email",
    handle: "chiwai.kiriba@gmail.com",
              ...
              {links.map((item) => (
                ...
                >
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="text-zinc-300 transition-colors group-hover:text-zinc-900 dark:text-zinc-700 dark:group-hover:text-zinc-100"
                  >
